...
public class DriverLogHistoryActivity extends AppCompatActivity {
    ...
    private void bindNavigation() {
        ...
        navDashboardItem.setOnClickListener(v -> {
            Intent intent = new Intent(DriverLogHistoryActivity.this, GpsNavigationActivity.class);
            startActivity(intent);
            finish();
        });
        ...
        navAlertsItem.setOnClickListener(v -> {
            Intent intent = new Intent(DriverLogHistoryActivity.this, AlertsActivity.class);
            startActivity(intent);
            finish();
        });
